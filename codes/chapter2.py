...
def temperature_ratio_plot(data_path, plotting_path, fig_config):
    """
    Plots temperature ratio and compare results between calorically
    perfect gas and nonequilibrium gas
    """
