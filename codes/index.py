...
# User Inputs #
altitude = np.linspace(0, 81e3, 80) #(0 to 81) [km]
mach_in = np.linspace(1, 10, 80) #(0.4 to 10) [mach]
wavelength_nm = 1000 
...
ax1.semilogy(mach_in, index_post_shock['dilute'] - 1,
             linewidth=fig_config["line_width"], label='Dilute')
ax1.semilogy(mach_in, index_post_shock['dense'] - 1,
...
ax1.semilogy(altitude, index_post_shock['dilute'] - 1,
             linewidth=fig_config["line_width"], label='Dilute')
ax1.semilogy(altitude, index_post_shock['dense'] - 1,
             linewidth=fig_config["line_width"], label='Dense')
