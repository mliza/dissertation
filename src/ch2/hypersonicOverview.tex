\section{Hypersonic Overview\label{ch2:hypersonicOverview}}
        ...
        Therefore, at these speeds, thermochemical effects need to be
        considered and accurate models that consider these effects need to be
        included. \FigRef{fig:ch2flightSpeedAltitude} shows the
        velocity-altitude trajectories for different hypersonic
        systems.\todo{Write about figure} 
        \pic{0.55}{chapter2/flightSpeedAltitude}{Velocity-altitude trajectories
