\section{Hypersonic Overview\label{ch2:hypersonicOverview}}
        ...
        When these additional energy modes are accessible the partition
        function, which describes the statistical
        properties of a system in thermal equilibrium needs to be modified.
        \FigRef{fig:ch2HeatCapacity} shows the change in heat capacity when
        ...
        modified to consider these additional \glspl{dof}. In statistical mechanics, the partition function is used to calculate the heat capacities of the system, which are then used to calculate macro properties such as heat transfer and temperature, which are employed in fluid dynamics.  \\
