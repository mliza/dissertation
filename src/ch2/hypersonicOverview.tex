\section{Hypersonic Overview\label{ch2:hypersonicOverview}}
        ...
        In a subsonic regime, compressibility effects can be ignored, 
        \FigRef{fig:ch2ShockMachRegions} shows how a flow changes as the Mach
        number increases. When the Mach number reaches the transonic regime,
        shock waves starts to form, across the shock the flow properties
        change. \todo{Update, the shock Mach regions} 
