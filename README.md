...
To compile the dissertation you hve to run compile.sh
...
**configuration:** contains the preamble, shortcuts and a submodule to 
a repo with additonal configurations
**codes:** contains all the code that will go in the appendix
